...
| 游戏 | 代表角色 | 备注 |
|------|---------|------|
| 🌌 **星穹铁道** | **花火、三月七** | 早期测试的功勋，被 Whisper 听丢语气词也不吭声 |
| 🏔️ **原神** | **七七** | 用最平静的声音参与了最不平静的测试 |
| ⚡ **崩坏3** | **人之律者** | 爱莉希雅，谢谢你还在 |
| 🎮 **绝区零** | **铃** | 新来的，绳匠的配音材料很珍贵 |
| 🌊 **鸣潮** | **今汐** | 今州令尹，声线稳得一批 |

也感谢 Whisper ASR —— 虽然经常把「嘿嘿~」听成「嘿嘿嘿」，
但用 initial_prompt 抢救的时候也确实努力过了（虽然对不同声音会幻觉，已弃用）。

最后感谢 VoxCPM2，用 steps=6, cfg=4.0 证明了自己才是情感之王 👑

---

*更新日志持续更新，下次更新不知道是什么时候，随缘。*
